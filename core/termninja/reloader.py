...
https://github.com/huge-success/sanic/blob/master/sanic/reloader_helpers.py

copying here because I don't want
to run termninja server with uvloop.

barely changed the code. MIT licensed (which i think means i can do this.)

if I do from sanic import reloader_helpers,
the default loop gets set to uvloop.
